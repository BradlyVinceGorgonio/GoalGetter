...
public class CompletedApprovedGroupTask extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_completed_approved_group_task);
        ...
        SubmittedFileTask = findViewById(R.id.SubmitFileTask);
